...
const Register = () => {
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    preferredRole: 'hauler', // Default role
    agreeToTerms: false,
  });
  ...
  // If already authenticated, don't show the registration form
  if (isAuthenticated) {
              ...
              <div className="mt-2 space-y-4">
                <div className="flex items-center">
                  ...
                  <label htmlFor="hauler" className="ml-3 block text-sm font-medium text-gray-700">
                    Hauler (I want to deliver items and earn money)
                  </label>
                </div>
                <div className="flex items-center">
                  <input
